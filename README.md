...
<p align="center"><img src="https://github.com/pavia27/co-culture-device/blob/main/fig2.png" width=80% height=80%></p>
...
<p align="center"><img src="https://github.com/pavia27/co-culture-device/blob/main/fig3.png" width=80% height=80%></p>

Figure 2. Boxplots comparing the area under the curve for co-cultures and monocultures of A. pasteurianus and L. plantarum on the modified BioMe microplate. $OD_{600}$ normalization and area under the curve calculations were carried out in the same way as the PMFB strains. 
...
## Citation
Pavia, MJ., Muse, C., Brownell, Z., Bean, HD., Cadillo-Quiroz, H. (2025) Substrate driven microbial interactions across geochemically distinct tropical peatlands *(in review)*
